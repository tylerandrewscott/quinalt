...
test = proj.info[is.na(match(proj.info$PROJNUM,oregon.owri.points$project_nb)),]

head(test)

oregon.owri.points$project_nb
proj.info$
...
head(oregon.owri.points.df)

test = oregon.owri.points@data
names(proj.info)

head(proj.info)
length(unique(test$project_nb))
length(unique(proj.info$PROJNUM))
proj.info$


sum(proj.info$PROJNUM %in% oregon.owri.points.df$project_nb)

head(oregon.owri.points.df)
sum(oregon.owri.points.df$project_nb %in% proj.info$PROJNUM)
