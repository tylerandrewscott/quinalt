...
round(mod_project_24$summary.fixed[-nrow(mod_project_24$summary.fixed),],3)
covars$OWEB_HUC8_Grant_Tech.WC_24

rownames(mod_project_24$summary.fixed)


outreach.wc = mod_project_24$summary.fixed$mean[10]
outreach.swcd = mod_project_24$summary.fixed$mean[11]
outreach.inter = mod_project_24$summary.fixed$mean[16]

tech.wc = mod_project_24$summary.fixed$mean[12]
tech.swcd = mod_project_24$summary.fixed$mean[13]
tech.inter = mod_project_24$summary.fixed$mean[17]

rest.wc = mod_project_24$summary.fixed$mean[14]
rest.swcd = mod_project_24$summary.fixed$mean[15]
rest.inter = mod_project_24$summary.fixed$mean[18]

all.inter = mod_project_24$summary.fixed$mean[19]

library(plyr)
library(dplyr)
library(tidyr)

temp = covars %>% select(contains('OWEB_HUC8_Grant_')) %>% select(contains('_24')) %>% select(contains('WC') )%>% select(-contains('Research')) %>% summarise_each(funs(mean))
temp = gather(temp); colnames(temp) = c("funding.type", "mean")
summary.varstats = temp
temp = covars %>% select(contains('OWEB_HUC8_Grant_')) %>% select(contains('_24')) %>% select(contains('WC') )%>% select(-contains('Research')) %>% summarise_each(funs(sd))
temp = gather(temp); colnames(temp) = c("funding.type", "sd")
summary.varstats <- join(summary.varstats, temp)


tech.wc + {mean(covars$OWEB_HUC8_Grant_Tech.SWCD_24)+sd(covars$OWEB_HUC8_Grant_Tech.SWCD_24)*2} *  tech.inter - 
  prod(summary.varstats$mean[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Tech.SWCD_24')] +
         2 * summary.varstats$sd[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Tech.SWCD_24')]) * all.inter

tech.wc + mean(covars$OWEB_HUC8_Grant_Tech.SWCD_24) *  tech.inter + 
  prod(summary.varstats$mean[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Tech.SWCD_24')]) * all.inter
...
rest.wc + {mean(covars$OWEB_HUC8_Grant_Restoration.SWCD_24)+sd(covars$OWEB_HUC8_Grant_Restoration.SWCD_24)*2} *  rest.inter - 
  prod(summary.varstats$mean[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Restoration.SWCD_24')] +
         2 * summary.varstats$sd[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Restoration.SWCD_24')]) * all.inter

rest.wc + mean(covars$OWEB_HUC8_Grant_Restoration.SWCD_24) *  rest.inter + 
  prod(summary.varstats$mean[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Restoration.SWCD_24')]) * all.inter
...
outreach.wc + {mean(covars$OWEB_HUC8_Grant_Outreach.SWCD_24)+sd(covars$OWEB_HUC8_Grant_Outreach.SWCD_24)*2} *  outreach.inter - 
  prod(summary.varstats$mean[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Outreach.SWCD_24')] +
         2 * summary.varstats$sd[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Outreach.SWCD_24')]) * all.inter

outreach.wc + mean(covars$OWEB_HUC8_Grant_Outreach.SWCD_24) *  outreach.inter + 
  prod(summary.varstats$mean[na.omit(match(rownames(mod_project_24$summary.fixed),summary.varstats$funding.type))][-which(rownames(mod_project_24$summary.fixed)=='OWEB_HUC8_Grant_Outreach.SWCD_24')]) * all.inter
...
tech.wc + (mean(covars$OWEB_HUC8_Grant_Tech.SWCD_24) + 2 * sd(covars$OWEB_HUC8_Grant_Tech.SWCD_24)) *  tech.inter
tech.wc + (mean(covars$OWEB_HUC8_Grant_Tech.SWCD_24) - 2 * sd(covars$OWEB_HUC8_Grant_Tech.SWCD_24)) *  tech.inter


mod_project_24$summary.fixed

mean(covars$OWEB_HUC8_Grant_Tech.WC_24) * 
mean(covars$OWEB_HUC8_Grant_Tech.SWCD_24)




hist(exp(covars$OWEB_Grant_Tech_24_WC))
