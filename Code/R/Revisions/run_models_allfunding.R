...
save.image('results_allfunding.RData')
mail::sendmail('tyler.andrew.scott@gmail.com','run_models_allfunding.R finished','nori has finished running allfunding comp models')
