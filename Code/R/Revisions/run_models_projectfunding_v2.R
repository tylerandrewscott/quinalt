...
X = cbind(rep(1,n.data),
          ...
          covars$OWEB_Grant_Outreach_12_WC*covars$OWEB_Grant_Outreach_12_WC, 
          
          covars$OWEB_Grant_Tech_12_WC, 
          covars$OWEB_Grant_Tech_12_SWCD,
          covars$OWEB_Grant_Tech_12_WC*covars$OWEB_Grant_Tech_12_WC, 
...
X = cbind(rep(1,n.data),
          ...
          covars$OWEB_Grant_Outreach_24_WC*covars$OWEB_Grant_Outreach_24_WC, 
          
          covars$OWEB_Grant_Tech_24_WC, 
          covars$OWEB_Grant_Tech_24_SWCD,
          covars$OWEB_Grant_Tech_24_WC*covars$OWEB_Grant_Tech_24_WC, 
...
X = cbind(rep(1,n.data),
          ...
          covars$OWEB_Grant_Outreach_36_WC*covars$OWEB_Grant_Outreach_36_WC, 
          
          covars$OWEB_Grant_Tech_36_WC, 
          covars$OWEB_Grant_Tech_36_SWCD,
          covars$OWEB_Grant_Tech_36_WC*covars$OWEB_Grant_Tech_36_WC, 
...
save.image('temp_projectresults_v2.RData')
