...
R1.ag.v = raster::extract(R1.ag,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R1.dev.v = raster::extract(R1.dev,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R1.wet.v = raster::extract(R1.wet,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R1.forst.v = raster::extract(R1.forst,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)

R2.crop.v = raster::extract(R2.crop,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R2.past.v = raster::extract(R2.past,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R2.dev.v = raster::extract(R2.dev,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R2.wet.v = raster::extract(R2.wet,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R2.forst.v = raster::extract(R2.forst,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R2.ag.v = data.frame(ID = R2.crop.v$ID,tf_ag_2001 = R2.crop.v$tf_crop_2001+R2.past.v$tf_past_2001)

R3.crop.v = raster::extract(R3.crop,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R3.past.v = raster::extract(R3.past,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R3.dev.v = raster::extract(R3.dev,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R3.wet.v = raster::extract(R3.wet,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
R3.forst.v = raster::extract(R3.forst,uq.points,fun=mean,df=T,buffer=100,na.rm=TRUE)
...
setwd('H:/quinalt')
save.image('midpoint.6.v2.RData')
