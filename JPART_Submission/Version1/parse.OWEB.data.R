...
colnames(grant.table) = c('Project Type','N','Average Amount ($)')
grant.table[5,] = c('All Grants',sum(grant.table$N),round(mean(dat2$Project.Amount),2))

library(stargazer)
setwd('H:/quinalt')
stargazer(grant.table,summary=F ,out='grant.table.html',type='html')
###########
